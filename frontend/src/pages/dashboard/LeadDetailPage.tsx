      ...
      <div className="grid gap-3 text-sm">
        ...
        {place.websiteUri && (
          <div className="flex items-center gap-2">
            ...
            <a href={place.websiteUri} target="_blank" rel="noopener noreferrer" className="text-violet-500 hover:underline inline-flex items-center gap-1">
  ...
  return (
    <section className="rounded-xl border border-border bg-card p-5 space-y-4 shadow-sm">
      ...
      {!analysis ? (
        ...
        <LeadDetailAnalysisView analysis={analysis} onReanalyze={onAnalyze} analyzing={analyzing} getProviderLabel={getAnalysisProviderLabel} />
      )}
    </section>
  );
}
