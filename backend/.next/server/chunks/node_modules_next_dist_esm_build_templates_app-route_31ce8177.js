...
REGRAS: Baseie-se APENAS nos dados fornecidos. Se n\xe3o houver dados para um campo, use null ou string vazia ou "N\xe3o encontrado" conforme o caso.`,{config:f}=await (0,N.resolveAiForRole)("company_analysis"),y=await (0,N.generateCompletionForRole)("company_analysis",{prompt:g,jsonMode:!0,maxTokens:4096});n&&y.usage&&(0,b.recordUsageEvent)({workspaceId:n,userId:t,type:"AI_TOKENS",quantity:1,metadata:{provider:f.provider,model:f.model,inputTokens:y.usage.inputTokens,outputTokens:y.usage.outputTokens}});try{let e=y.text.replace(/```json\s*/gi,"").replace(/```\s*/gi,"").trim();r=JSON.parse(e),o={summary:"string"==typeof r.summary?r.summary:"Análise gerada.",strengths:Array.isArray(r.strengths)?r.strengths:[],weaknesses:Array.isArray(r.weaknesses)?r.weaknesses:[],opportunities:Array.isArray(r.opportunities)?r.opportunities:[],reclameAquiSummary:"string"==typeof r.reclameAquiSummary?r.reclameAquiSummary:void 0,googlePresenceScore:"number"==typeof r.googlePresenceScore?r.googlePresenceScore:void 0,googleRating:"number"==typeof r.googleRating?r.googleRating:void 0,googleReviewCount:"number"==typeof r.googleReviewCount?r.googleReviewCount:void 0,googleReviewsSnippets:Array.isArray(r.googleReviewsSnippets)?r.googleReviewsSnippets:void 0,socialNetworks:!(a=r.socialNetworks)||"object"!=typeof a||Array.isArray(a)?{presence:""}:{presence:"string"==typeof a.presence?a.presence:"",perNetwork:Array.isArray(a.perNetwork)?a.perNetwork:void 0,consistency:"string"==typeof a.consistency?a.consistency:void 0,recommendations:Array.isArray(a.recommendations)?a.recommendations:void 0},suggestedNiche:"string"==typeof r.suggestedNiche?r.suggestedNiche:void 0,suggestedBusinessModel:"string"==typeof r.suggestedBusinessModel?r.suggestedBusinessModel:void 0,recommendations:Array.isArray(r.recommendations)?r.recommendations:[]}}catch{o={summary:"Não foi possível gerar a análise completa. Tente novamente.",strengths:[],weaknesses:[],opportunities:[],socialNetworks:{presence:""},recommendations:["Preencha o perfil da empresa e execute novamente."]}}return n&&w.prisma.intelligenceReport.create({data:{workspaceId:n,userId:t,module:"MY_COMPANY",inputQuery:e.companyName,inputCity:l||null,inputState:d||null,resultsData:JSON.parse(JSON.stringify(o))}}).catch(e=>C.logger.error("Failed to persist company analysis report",{error:e instanceof Error?e.message:"Unknown"})),o}let T={companyName:!0,productService:!0,targetAudience:!0,mainBenefit:!0,address:!0,linkedInUrl:!0,instagramUrl:!0,facebookUrl:!0,websiteUrl:!0};async function $(t){let r=(0,k.getOrCreateRequestId)(t);try{let e=t.headers.get("x-forwarded-for")||"127.0.0.1",{success:a}=await (0,R.rateLimit)(`company-analysis:${e}`,10,60);if(!a)return(0,k.jsonWithRequestId)({error:"Too many requests. Try again later."},{status:429,requestId:r});let o=await (0,h.auth)();if(!o?.user?.id)return(0,k.jsonWithRequestId)({error:"Unauthorized"},{status:401,requestId:r});let n=await w.prisma.workspaceMember.findFirst({where:{userId:o.user.id},include:{workspace:{select:{...T,plan:!0}}}});if(!n?.workspace)return(0,k.jsonWithRequestId)({error:"Workspace not found"},{status:404,requestId:r});let i=n.workspace.plan;if(!(0,x.planHasModule)(i,"ANALISE_MINHA_EMPRESA"))return(0,k.jsonWithRequestId)({error:"Análise da minha empresa está disponível nos planos Business e Enterprise. Faça upgrade para acessar."},{status:403,requestId:r});let s=await t.json().catch(()=>({})),l=A.companyAnalysisSchema.safeParse(s),d=l.success?l.data:{useProfile:!0,companyName:void 0,city:void 0,state:void 0,productService:void 0,targetAudience:void 0,mainBenefit:void 0,address:void 0,websiteUrl:void 0,linkedInUrl:void 0,instagramUrl:void 0,facebookUrl:void 0},u=n.workspace,c=!1!==d.useProfile;if(!(c?(d.companyName??u.companyName??"").trim():(d.companyName??"").trim()))return(0,k.jsonWithRequestId)({error:c?"Preencha o nome da empresa no Perfil da empresa (Configurações > Empresa) ou envie companyName no corpo da requisição.":'No modo "Pesquisar", informe o nome da empresa (companyName) no corpo da requisição.'},{status:400,requestId:r});let p=c?{companyName:(d.companyName??u.companyName??"").trim(),productService:u.productService??void 0,targetAudience:u.targetAudience??void 0,mainBenefit:u.mainBenefit??void 0,address:u.address??void 0,websiteUrl:u.websiteUrl??void 0,linkedInUrl:u.linkedInUrl??void 0,instagramUrl:u.instagramUrl??void 0,facebookUrl:u.facebookUrl??void 0,city:d.city,state:d.state}:{companyName:(d.companyName??"").trim(),productService:d.productService,targetAudience:d.targetAudience,mainBenefit:d.mainBenefit,address:d.address,websiteUrl:d.websiteUrl,linkedInUrl:d.linkedInUrl,instagramUrl:d.instagramUrl,facebookUrl:d.facebookUrl,city:d.city,state:d.state},m=await q(p,o.user.id);return(0,k.jsonWithRequestId)(m,{requestId:r})}catch(a){let{logger:t}=await e.A(31443);return t.error("Company analysis error",{error:a instanceof Error?a.message:"Unknown"},r),(0,k.jsonWithRequestId)({error:"Internal server error"},{status:500,requestId:r})}}e.s(["POST",()=>$],62281);var O=e.i(62281);let _=new t.AppRouteRouteModule({definition:{kind:r.RouteKind.APP_ROUTE,page:"/api/company-analysis/route",pathname:"/api/company-analysis",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/backend/src/app/api/company-analysis/route.ts",nextConfigOutput:"standalone",userland:O}),{workAsyncStorage:B,workUnitAsyncStorage:M,serverHooks:j}=_;function H(){return(0,a.patchFetch)({workAsyncStorage:B,workUnitAsyncStorage:M})}async function F(e,t,a){_.isDev&&(0,o.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let h="/api/company-analysis/route";h=h.replace(/\/index$/,"")||"/";let w=await _.prepare(e,t,{srcPage:h,multiZoneDraftMode:!1});if(!w)return t.statusCode=400,t.end("Bad Request"),null==a.waitUntil||a.waitUntil.call(a,Promise.resolve()),null;let{buildId:R,params:k,nextConfig:x,parsedUrl:A,isDraftMode:N,prerenderManifest:E,routerServerContext:S,isOnDemandRevalidate:U,revalidateOnlyGenerated:b,resolvedPathname:C,clientReferenceManifest:I,serverActionsManifest:P}=w,q=(0,s.normalizeAppPath)(h),T=!!(E.dynamicRoutes[q]||E.routes[C]),$=async()=>((null==S?void 0:S.render404)?await S.render404(e,t,A,!1):t.end("This page could not be found"),null);if(T&&!N){let e=!!E.routes[C],t=E.dynamicRoutes[q];if(t&&!1===t.fallback&&!e){if(x.experimental.adapterPath)return await $();throw new y.NoFallbackError}}let O=null;!T||_.isDev||N||(O="/index"===(O=C)?"/":O);let B=!0===_.isDev||!T,M=T&&!B;P&&I&&(0,i.setManifestsSingleton)({page:h,clientReferenceManifest:I,serverActionsManifest:P});let j=e.method||"GET",H=(0,n.getTracer)(),F=H.getActiveScopeSpan(),L={params:k,prerenderManifest:E,renderOpts:{experimental:{authInterrupts:!!x.experimental.authInterrupts},cacheComponents:!!x.cacheComponents,supportsDynamicResponse:B,incrementalCache:(0,o.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:x.cacheLife,waitUntil:a.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,r,a,o)=>_.onRequestError(e,t,a,o,S)},sharedContext:{buildId:R}},D=new l.NodeNextRequest(e),G=new l.NodeNextResponse(t),W=d.NextRequestAdapter.fromNodeNextRequest(D,(0,d.signalFromNodeResponse)(t));try{let i=async e=>_.handle(W,L).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let r=H.getRootSpanAttributes();if(!r)return;if(r.get("next.span_type")!==u.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${r.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let a=r.get("next.route");if(a){let t=`${j} ${a}`;e.setAttributes({"next.route":a,"http.route":a,"next.span_name":t}),e.updateName(t)}else e.updateName(`${j} ${h}`)}),s=!!(0,o.getRequestMeta)(e,"minimalMode"),l=async o=>{var n,l;let d=async({previousCacheEntry:r})=>{try{if(!s&&U&&b&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await i(o);e.fetchMetrics=L.renderOpts.fetchMetrics;let l=L.renderOpts.pendingWaitUntil;l&&a.waitUntil&&(a.waitUntil(l),l=void 0);let d=L.renderOpts.collectedTags;if(!T)return await (0,p.sendResponse)(D,G,n,L.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,m.toNodeOutgoingHttpHeaders)(n.headers);d&&(t[f.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let r=void 0!==L.renderOpts.collectedRevalidate&&!(L.renderOpts.collectedRevalidate>=f.INFINITE_CACHE)&&L.renderOpts.collectedRevalidate,a=void 0===L.renderOpts.collectedExpire||L.renderOpts.collectedExpire>=f.INFINITE_CACHE?void 0:L.renderOpts.collectedExpire;return{value:{kind:v.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:r,expire:a}}}}catch(t){throw(null==r?void 0:r.isStale)&&await _.onRequestError(e,t,{routerKind:"App Router",routePath:h,routeType:"route",revalidateReason:(0,c.getRevalidateReason)({isStaticGeneration:M,isOnDemandRevalidate:U})},!1,S),t}},u=await _.handleResponse({req:e,nextConfig:x,cacheKey:O,routeKind:r.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:E,isRoutePPREnabled:!1,isOnDemandRevalidate:U,revalidateOnlyGenerated:b,responseGenerator:d,waitUntil:a.waitUntil,isMinimalMode:s});if(!T)return null;if((null==u||null==(n=u.value)?void 0:n.kind)!==v.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==u||null==(l=u.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});s||t.setHeader("x-nextjs-cache",U?"REVALIDATED":u.isMiss?"MISS":u.isStale?"STALE":"HIT"),N&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let y=(0,m.fromNodeOutgoingHttpHeaders)(u.value.headers);return s&&T||y.delete(f.NEXT_CACHE_TAGS_HEADER),!u.cacheControl||t.getHeader("Cache-Control")||y.get("Cache-Control")||y.set("Cache-Control",(0,g.getCacheControlHeader)(u.cacheControl)),await (0,p.sendResponse)(D,G,new Response(u.value.body,{headers:y,status:u.value.status||200})),null};F?await l(F):await H.withPropagatedContext(e.headers,()=>H.trace(u.BaseServerSpan.handleRequest,{spanName:`${j} ${h}`,kind:n.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},l))}catch(t){if(t instanceof y.NoFallbackError||await _.onRequestError(e,t,{routerKind:"App Router",routePath:q,routeType:"route",revalidateReason:(0,c.getRevalidateReason)({isStaticGeneration:M,isOnDemandRevalidate:U})},!1,S),T)throw t;return await (0,p.sendResponse)(D,G,new Response(null,{status:500})),null}}e.s(["handler",()=>F,"patchFetch",()=>H,"routeModule",()=>_,"serverHooks",()=>j,"workAsyncStorage",()=>B,"workUnitAsyncStorage",()=>M],86929)}];
